...
from services.brain_tumor import predict_brain_tumor
from services.skin_cancer_api import predict_skin_cancer
...
async def predict(
    ...
    if diagnosis_type == "brain_tumor":
        return await predict_brain_tumor(file)

    elif diagnosis_type == "skin_cancer":
        return await predict_skin_cancer(file)
